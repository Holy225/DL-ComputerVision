...
class OnlineTracker(object):
    ...
    def __init__(self, model_path, min_cls_score=0.4, min_ap_dist=0.64, max_time_lost=30, use_tracking=True, use_refind=False):
    ...
    def update(self, image, tlwhs, det_scores=None):
        ...
        tic, toc = time.time(),time.time() - tic
        time_data.append(toc) 
        ...
        return output_stracks, time_data
