...
from models.reid.FeatureExtractor_square import FeatureExtractor
#from models.reid.FeatureExtractor import FeatureExtractor

def load_reid_model(ckpt):
    model = FeatureExtractor(n_parts=8)
    #model.inp_size = (80,160)
    model.inp_size = (128,128)
